...
<section>
  <header className=' mx-auto px-5 flex justify-between py-4 bg-[#D32828]'>
    ...
    <div className={` ${navIsvisible ? "right-0" : "-right-full"} transition-all duration-300 gap-y-5 z-49 flex flex-col w-full lg:w-auto justify-center lg:flex-row lg:justify-end fixed top-0 bottom-0  items-center gap-x-4 lg:static bg-gray-700 mt-[96px] lg:mt-0 lg:bg-transparent`}>
